      ...
      <nav className="sticky top-0 z-50 bg-white border-b-2 border-black transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between py-4 gap-4 md:gap-0">
                ...
                {isDropdownOpen && (
                <div className="absolute group right-14 mt-48 w-48 bg-white border-2 border-black overflow-hidden flex flex-col">
                    ...
                    <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="px-4 py-3 text-black font-bold hover:text-gray-500 transition flex items-center gap-2 border-b"
                    >
                    ...
                    <a 
                        href="https://mail.google.com/mail/?view=cm&fs=1&to=kalebcoyo@gmail.com"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-4 py-3 text-black font-bold hover:text-red-800 transition flex items-center gap-2 underline"
                    >
